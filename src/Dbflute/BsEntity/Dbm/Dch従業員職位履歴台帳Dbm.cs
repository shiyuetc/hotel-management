...
namespace Dbflute.BsEntity.Dbm {
    ...
    public class Dch従業員職位履歴台帳Dbm : AbstractDBMeta {
        ...
        protected void InitializeColumnInfo() {
            ...
            _column従業員コード = cci("従業員コード", "従業員コード", null, null, true, "従業員コード", typeof(String), false, "bpchar", 10, 0, false, OptimisticLockType.NONE, null, "mst従業員マスタ", null);
        ...
        public ForeignInfo ForeignMst従業員マスタ { get {
            ...
            map.put(Column従業員コード, Mst従業員マスタDbm.GetInstance().Column従業員コード);
        ...
        public class EntityProperty従業員コードSetupper : EntityPropertySetupper<Dch従業員職位履歴台帳> {
            public void Setup(Dch従業員職位履歴台帳 entity, Object value) { entity.従業員コード = (value != null) ? (String)value : null; }
        }
