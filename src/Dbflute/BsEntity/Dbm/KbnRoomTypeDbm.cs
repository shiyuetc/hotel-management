...
namespace Dbflute.BsEntity.Dbm {
    ...
    public class KbnRoomTypeDbm : AbstractDBMeta {

        public static readonly Type ENTITY_TYPE = typeof(KbnRoomType);

        private static readonly KbnRoomTypeDbm _instance = new KbnRoomTypeDbm();
        private KbnRoomTypeDbm() {
            InitializeColumnInfo();
            InitializeColumnInfoList();
            InitializeEntityPropertySetupper();
        }
        public static KbnRoomTypeDbm GetInstance() {
            return _instance;
        }
        ...
        public override String TablePropertyName { get { return "KbnRoomType"; } }
        public override String TableSqlName { get { return "kbn_room_type"; } }
        ...
        //                                             Table
        //                                             -----
        public static readonly String TABLE_DB_NAME = "kbn_room_type";
        public static readonly String TABLE_PROPERTY_NAME = "KbnRoomType";
        ...
        //                                                                       Type Name
        //                                                                       =========
        public override String EntityTypeName { get { return "Dbflute.ExEntity.KbnRoomType"; } }
        public override String DaoTypeName { get { return "Dbflute.ExDao.KbnRoomTypeDao"; } }
        public override String ConditionBeanTypeName { get { return "Dbflute.CBean.KbnRoomTypeCB"; } }
        public override String BehaviorTypeName { get { return "Dbflute.ExBhv.KbnRoomTypeBhv"; } }
        ...
        public KbnRoomType NewMyEntity() { return new KbnRoomType(); }
        public override ConditionBean NewConditionBean() { return NewMyConditionBean(); }
        public KbnRoomTypeCB NewMyConditionBean() { return new KbnRoomTypeCB(); }

        // ===============================================================================
        //                                                           Entity Property Setup
        //                                                           =====================
        protected Map<String, EntityPropertySetupper<KbnRoomType>> _entityPropertySetupperMap = new LinkedHashMap<String, EntityPropertySetupper<KbnRoomType>>();
        ...
        public override void SetupEntityProperty(String propertyName, Object entity, Object value) {
            EntityPropertySetupper<KbnRoomType> callback = _entityPropertySetupperMap.get(propertyName);
            callback.Setup((KbnRoomType)entity, value);
        }

        public class EntityPropertyCodeSetupper : EntityPropertySetupper<KbnRoomType> {
            public void Setup(KbnRoomType entity, Object value) { entity.Code = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyNameSetupper : EntityPropertySetupper<KbnRoomType> {
            public void Setup(KbnRoomType entity, Object value) { entity.Name = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyPriceSetupper : EntityPropertySetupper<KbnRoomType> {
            public void Setup(KbnRoomType entity, Object value) { entity.Price = (value != null) ? (int?)value : null; }
        }
        public class EntityPropertyCapacitySetupper : EntityPropertySetupper<KbnRoomType> {
            public void Setup(KbnRoomType entity, Object value) { entity.Capacity = (value != null) ? (int?)value : null; }
        }
        public class EntityPropertyDescriptionSetupper : EntityPropertySetupper<KbnRoomType> {
            public void Setup(KbnRoomType entity, Object value) { entity.Description = (value != null) ? (String)value : null; }
        }
    }
}
