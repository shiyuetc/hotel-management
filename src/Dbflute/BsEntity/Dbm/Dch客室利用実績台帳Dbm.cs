...
namespace Dbflute.BsEntity.Dbm {
    ...
    public class Dch客室利用実績台帳Dbm : AbstractDBMeta {
        ...
        public class EntityProperty客室利用コードSetupper : EntityPropertySetupper<Dch客室利用実績台帳> {
            public void Setup(Dch客室利用実績台帳 entity, Object value) { entity.客室利用コード = (value != null) ? (String)value : null; }
        }
