...
namespace Dbflute.BsEntity.Dbm {
    ...
    public class Dch客室利用予定台帳Dbm : AbstractDBMeta {
        ...
        protected void InitializeColumnInfo() {
            _columnId = cci("id", "id", null, null, true, "Id", typeof(long?), true, "bigserial", 19, 0, false, OptimisticLockType.NONE, null, null, "dchその他予定台帳List,dch宿泊予定台帳List,dch清掃予定台帳List");
        ...
        public ForeignInfo ForeignKbn客室利用区分 { get {
            Map<ColumnInfo, ColumnInfo> map = new LinkedHashMap<ColumnInfo, ColumnInfo>();
            map.put(Column客室利用コード, Kbn客室利用区分Dbm.GetInstance().Columnコード);
        ...
        //                                  Referrer Element
        //                                  ----------------
        public ReferrerInfo ReferrerDchその他予定台帳List { get {
            Map<ColumnInfo, ColumnInfo> map = new LinkedHashMap<ColumnInfo, ColumnInfo>();
            map.put(ColumnId, Dchその他予定台帳Dbm.GetInstance().Column客室利用予定台帳id);
            return cri("Dchその他予定台帳List", this, Dchその他予定台帳Dbm.GetInstance(), map, false);
        }}
        ...
        public ReferrerInfo ReferrerDch清掃予定台帳List { get {
            Map<ColumnInfo, ColumnInfo> map = new LinkedHashMap<ColumnInfo, ColumnInfo>();
            map.put(ColumnId, Dch清掃予定台帳Dbm.GetInstance().Column客室利用予定台帳id);
            return cri("Dch清掃予定台帳List", this, Dch清掃予定台帳Dbm.GetInstance(), map, false);
        }}
        ...
        //                                     Referrer Name
        //                                     -------------
        public static readonly String REFERRER_PROPERTY_NAME_Dchその他予定台帳List = "Dchその他予定台帳List";
        public static readonly String REFERRER_PROPERTY_NAME_Dch宿泊予定台帳List = "Dch宿泊予定台帳List";
        public static readonly String REFERRER_PROPERTY_NAME_Dch清掃予定台帳List = "Dch清掃予定台帳List";
        ...
        public class EntityProperty客室利用コードSetupper : EntityPropertySetupper<Dch客室利用予定台帳> {
            public void Setup(Dch客室利用予定台帳 entity, Object value) { entity.客室利用コード = (value != null) ? (String)value : null; }
        }
