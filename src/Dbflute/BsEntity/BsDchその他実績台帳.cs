...
namespace Dbflute.ExEntity {
    ...
    /// <summary>
    /// The entity of dchその他実績台帳 as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     id
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("dchその他実績台帳")]
    [System.Serializable]
    public partial class Dchその他実績台帳 : Entity {
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "dchその他実績台帳"; } }
        public String TablePropertyName { get { return "Dchその他実績台帳"; } }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is Dchその他実績台帳)) { return false; }
            Dchその他実績台帳 otherEntity = (Dchその他実績台帳)other;
        ...
        public override String ToString() {
            return "Dchその他実績台帳:" + BuildColumnString() + BuildRelationString();
        }
