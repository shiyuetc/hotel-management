...
namespace Dbflute.ExEntity {
    ...
    /// <summary>
    /// The entity of dch清掃予定台帳 as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     id
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("dch清掃予定台帳")]
    [System.Serializable]
    public partial class Dch清掃予定台帳 : Entity {
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "dch清掃予定台帳"; } }
        public String TablePropertyName { get { return "Dch清掃予定台帳"; } }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is Dch清掃予定台帳)) { return false; }
            Dch清掃予定台帳 otherEntity = (Dch清掃予定台帳)other;
        ...
        public override String ToString() {
            return "Dch清掃予定台帳:" + BuildColumnString() + BuildRelationString();
        }
