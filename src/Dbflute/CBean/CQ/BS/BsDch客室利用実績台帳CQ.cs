...
namespace Dbflute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public class BsDch客室利用実績台帳CQ : AbstractBsDch客室利用実績台帳CQ {

        protected Dch客室利用実績台帳CIQ _inlineQuery;

        public BsDch客室利用実績台帳CQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public Dch客室利用実績台帳CIQ Inline() {
            if (_inlineQuery == null) {
                _inlineQuery = new Dch客室利用実績台帳CIQ(xgetReferrerQuery(), xgetSqlClause(), xgetAliasName(), xgetNestLevel(), this);
            }
            _inlineQuery.xsetOnClause(false);
            return _inlineQuery;
        }
        
        public Dch客室利用実績台帳CIQ On() {
            if (isBaseQuery()) { throw new UnsupportedOperationException("Unsupported onClause of Base Table!"); }
            Dch客室利用実績台帳CIQ inlineQuery = Inline();
        ...
        public Map<String, Dch宿泊実績台帳CQ> Id_NotExistsSubQuery_Dch宿泊実績台帳List { get { return _id_NotExistsSubQuery_Dch宿泊実績台帳ListMap; }}
        public override String keepId_NotExistsSubQuery_Dch宿泊実績台帳List(Dch宿泊実績台帳CQ subQuery) {
            if (_id_NotExistsSubQuery_Dch宿泊実績台帳ListMap == null) { _id_NotExistsSubQuery_Dch宿泊実績台帳ListMap = new LinkedHashMap<String, Dch宿泊実績台帳CQ>(); }
            String key = "subQueryMapKey" + (_id_NotExistsSubQuery_Dch宿泊実績台帳ListMap.size() + 1);
        ...
        public Map<String, Dch宿泊実績台帳CQ> Id_NotInScopeSubQuery_Dch宿泊実績台帳List { get { return _id_NotInScopeSubQuery_Dch宿泊実績台帳ListMap; }}
        public override String keepId_NotInScopeSubQuery_Dch宿泊実績台帳List(Dch宿泊実績台帳CQ subQuery) {
            if (_id_NotInScopeSubQuery_Dch宿泊実績台帳ListMap == null) { _id_NotInScopeSubQuery_Dch宿泊実績台帳ListMap = new LinkedHashMap<String, Dch宿泊実績台帳CQ>(); }
            String key = "subQueryMapKey" + (_id_NotInScopeSubQuery_Dch宿泊実績台帳ListMap.size() + 1);
        ...
        public Map<String, Dch宿泊実績台帳CQ> Id_QueryDerivedReferrer_Dch宿泊実績台帳List { get { return _id_QueryDerivedReferrer_Dch宿泊実績台帳ListMap; } }
        public override String keepId_QueryDerivedReferrer_Dch宿泊実績台帳List(Dch宿泊実績台帳CQ subQuery) {
            if (_id_QueryDerivedReferrer_Dch宿泊実績台帳ListMap == null) { _id_QueryDerivedReferrer_Dch宿泊実績台帳ListMap = new LinkedHashMap<String, Dch宿泊実績台帳CQ>(); }
            String key = "subQueryMapKey" + (_id_QueryDerivedReferrer_Dch宿泊実績台帳ListMap.size() + 1);
            _id_QueryDerivedReferrer_Dch宿泊実績台帳ListMap.put(key, subQuery); return "Id_QueryDerivedReferrer_Dch宿泊実績台帳List." + key;
        }
        protected Map<String, Object> _id_QueryDerivedReferrer_Dch宿泊実績台帳ListParameterMap;
        public Map<String, Object> Id_QueryDerivedReferrer_Dch宿泊実績台帳ListParameter { get { return _id_QueryDerivedReferrer_Dch宿泊実績台帳ListParameterMap; } }
        ...
        public BsDch客室利用実績台帳CQ AddOrderBy_Id_Desc() { regOBD("id");return this; }
        ...
        public BsDch客室利用実績台帳CQ AddOrderBy_利用開始日時_Asc() { regOBA("利用開始日時");return this; }
        public BsDch客室利用実績台帳CQ AddOrderBy_利用開始日時_Desc() { regOBD("利用開始日時");return this; }
        ...
        public override void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
            Dch客室利用実績台帳CQ baseQuery = (Dch客室利用実績台帳CQ)baseQueryAsSuper;
            Dch客室利用実績台帳CQ unionQuery = (Dch客室利用実績台帳CQ)unionQueryAsSuper;
        ...
        protected String resolveNextRelationPathMst客室マスタ() {
            return resolveNextRelationPath("dch客室利用実績台帳", "mst客室マスタ");
        }
        ...
        protected String resolveNextRelationPathKbn客室利用区分() {
            return resolveNextRelationPath("dch客室利用実績台帳", "kbn客室利用区分");
        }
	    ...
	    //                                                                 Scalar SubQuery
	    //                                                                 ===============
	    protected Map<String, Dch客室利用実績台帳CQ> _scalarSubQueryMap;
	    public Map<String, Dch客室利用実績台帳CQ> ScalarSubQuery { get { return _scalarSubQueryMap; } }
	    public override String keepScalarSubQuery(Dch客室利用実績台帳CQ subQuery) {
	        if (_scalarSubQueryMap == null) { _scalarSubQueryMap = new LinkedHashMap<String, Dch客室利用実績台帳CQ>(); }
        ...
        //                                                         =======================
        protected Map<String, Dch客室利用実績台帳CQ> _myselfInScopeSubQueryMap;
        public Map<String, Dch客室利用実績台帳CQ> MyselfInScopeSubQuery { get { return _myselfInScopeSubQueryMap; } }
        public override String keepMyselfInScopeSubQuery(Dch客室利用実績台帳CQ subQuery) {
            if (_myselfInScopeSubQueryMap == null) { _myselfInScopeSubQueryMap = new LinkedHashMap<String, Dch客室利用実績台帳CQ>(); }
