...
namespace Dbflute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class AbstractBsMstRoomCQ : AbstractConditionQuery {

        public AbstractBsMstRoomCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public override String getTableDbName() { return "mst_room"; }
        public override String getTableSqlName() { return "mst_room"; }
        ...
        //                                                                    Scalar Condition
        //                                                                    ================
        public SSQFunction<MstRoomCB> Scalar_Equal() {
            return xcreateSSQFunction("=");
        }

        public SSQFunction<MstRoomCB> Scalar_NotEqual() {
            return xcreateSSQFunction("<>");
        }

        public SSQFunction<MstRoomCB> Scalar_GreaterEqual() {
            return xcreateSSQFunction(">=");
        }

        public SSQFunction<MstRoomCB> Scalar_GreaterThan() {
            return xcreateSSQFunction(">");
        }

        public SSQFunction<MstRoomCB> Scalar_LessEqual() {
            return xcreateSSQFunction("<=");
        }

        public SSQFunction<MstRoomCB> Scalar_LessThan() {
            return xcreateSSQFunction("<");
        }

        protected SSQFunction<MstRoomCB> xcreateSSQFunction(String operand) {
            return new SSQFunction<MstRoomCB>(delegate(String function, SubQuery<MstRoomCB> subQuery) {
                xscalarSubQuery(function, subQuery, operand);
            });
        }

        protected void xscalarSubQuery(String function, SubQuery<MstRoomCB> subQuery, String operand) {
            assertObjectNotNull("subQuery<MstRoomCB>", subQuery);
            MstRoomCB cb = new MstRoomCB(); cb.xsetupForScalarCondition(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepScalarSubQuery(cb.Query()); // for saving query-value.
            registerScalarSubQuery(function, cb.Query(), subQueryPropertyName, operand);
        }
        public abstract String keepScalarSubQuery(MstRoomCQ subQuery);

        // ===============================================================================
        //                                                                  MySelf InScope
        //                                                                  ==============
        public void MyselfInScope(SubQuery<MstRoomCB> subQuery) {
            assertObjectNotNull("subQuery<MstRoomCB>", subQuery);
            MstRoomCB cb = new MstRoomCB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepMyselfInScopeSubQuery(cb.Query()); // for saving query-value.
            registerInScopeSubQuery(cb.Query(), "id", "id", subQueryPropertyName);
        }
        public abstract String keepMyselfInScopeSubQuery(MstRoomCQ subQuery);
