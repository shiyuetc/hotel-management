...
namespace Dbflute.CBean.CQ.BS {
    ...
    public abstract class AbstractBsDch客室利用予定台帳CQ : AbstractConditionQuery {
        ...
        public void ExistsDchその他予定台帳List(SubQuery<Dchその他予定台帳CB> subQuery) {
            assertObjectNotNull("subQuery<Dchその他予定台帳CB>", subQuery);
            Dchその他予定台帳CB cb = new Dchその他予定台帳CB(); cb.xsetupForExistsReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_ExistsSubQuery_Dchその他予定台帳List(cb.Query());
            registerExistsSubQuery(cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName);
        }
        public abstract String keepId_ExistsSubQuery_Dchその他予定台帳List(Dchその他予定台帳CQ subQuery);
        ...
        public void ExistsDch清掃予定台帳List(SubQuery<Dch清掃予定台帳CB> subQuery) {
            assertObjectNotNull("subQuery<Dch清掃予定台帳CB>", subQuery);
            Dch清掃予定台帳CB cb = new Dch清掃予定台帳CB(); cb.xsetupForExistsReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_ExistsSubQuery_Dch清掃予定台帳List(cb.Query());
            registerExistsSubQuery(cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName);
        }
        public abstract String keepId_ExistsSubQuery_Dch清掃予定台帳List(Dch清掃予定台帳CQ subQuery);
        public void NotExistsDchその他予定台帳List(SubQuery<Dchその他予定台帳CB> subQuery) {
            assertObjectNotNull("subQuery<Dchその他予定台帳CB>", subQuery);
            Dchその他予定台帳CB cb = new Dchその他予定台帳CB(); cb.xsetupForExistsReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_NotExistsSubQuery_Dchその他予定台帳List(cb.Query());
            registerNotExistsSubQuery(cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName);
        }
        public abstract String keepId_NotExistsSubQuery_Dchその他予定台帳List(Dchその他予定台帳CQ subQuery);
        ...
        public void NotExistsDch清掃予定台帳List(SubQuery<Dch清掃予定台帳CB> subQuery) {
            assertObjectNotNull("subQuery<Dch清掃予定台帳CB>", subQuery);
            Dch清掃予定台帳CB cb = new Dch清掃予定台帳CB(); cb.xsetupForExistsReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_NotExistsSubQuery_Dch清掃予定台帳List(cb.Query());
            registerNotExistsSubQuery(cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName);
        }
        public abstract String keepId_NotExistsSubQuery_Dch清掃予定台帳List(Dch清掃予定台帳CQ subQuery);
        public void InScopeDchその他予定台帳List(SubQuery<Dchその他予定台帳CB> subQuery) {
            assertObjectNotNull("subQuery<Dchその他予定台帳CB>", subQuery);
            Dchその他予定台帳CB cb = new Dchその他予定台帳CB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_InScopeSubQuery_Dchその他予定台帳List(cb.Query());
            registerInScopeSubQuery(cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName);
        }
        public abstract String keepId_InScopeSubQuery_Dchその他予定台帳List(Dchその他予定台帳CQ subQuery);
        ...
        public void InScopeDch清掃予定台帳List(SubQuery<Dch清掃予定台帳CB> subQuery) {
            assertObjectNotNull("subQuery<Dch清掃予定台帳CB>", subQuery);
            Dch清掃予定台帳CB cb = new Dch清掃予定台帳CB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_InScopeSubQuery_Dch清掃予定台帳List(cb.Query());
            registerInScopeSubQuery(cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName);
        }
        public abstract String keepId_InScopeSubQuery_Dch清掃予定台帳List(Dch清掃予定台帳CQ subQuery);
        public void NotInScopeDchその他予定台帳List(SubQuery<Dchその他予定台帳CB> subQuery) {
            assertObjectNotNull("subQuery<Dchその他予定台帳CB>", subQuery);
            Dchその他予定台帳CB cb = new Dchその他予定台帳CB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_NotInScopeSubQuery_Dchその他予定台帳List(cb.Query());
            registerNotInScopeSubQuery(cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName);
        }
        public abstract String keepId_NotInScopeSubQuery_Dchその他予定台帳List(Dchその他予定台帳CQ subQuery);
        ...
        public void NotInScopeDch清掃予定台帳List(SubQuery<Dch清掃予定台帳CB> subQuery) {
            assertObjectNotNull("subQuery<Dch清掃予定台帳CB>", subQuery);
            Dch清掃予定台帳CB cb = new Dch清掃予定台帳CB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_NotInScopeSubQuery_Dch清掃予定台帳List(cb.Query());
            registerNotInScopeSubQuery(cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName);
        }
        public abstract String keepId_NotInScopeSubQuery_Dch清掃予定台帳List(Dch清掃予定台帳CQ subQuery);
        public void xsderiveDchその他予定台帳List(String function, SubQuery<Dchその他予定台帳CB> subQuery, String aliasName) {
            assertObjectNotNull("subQuery<Dchその他予定台帳CB>", subQuery);
            Dchその他予定台帳CB cb = new Dchその他予定台帳CB(); cb.xsetupForDerivedReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_SpecifyDerivedReferrer_Dchその他予定台帳List(cb.Query());
            registerSpecifyDerivedReferrer(function, cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName, aliasName);
        }
        abstract public String keepId_SpecifyDerivedReferrer_Dchその他予定台帳List(Dchその他予定台帳CQ subQuery);
        ...
        public void xsderiveDch清掃予定台帳List(String function, SubQuery<Dch清掃予定台帳CB> subQuery, String aliasName) {
            assertObjectNotNull("subQuery<Dch清掃予定台帳CB>", subQuery);
            Dch清掃予定台帳CB cb = new Dch清掃予定台帳CB(); cb.xsetupForDerivedReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_SpecifyDerivedReferrer_Dch清掃予定台帳List(cb.Query());
            registerSpecifyDerivedReferrer(function, cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName, aliasName);
        }
        abstract public String keepId_SpecifyDerivedReferrer_Dch清掃予定台帳List(Dch清掃予定台帳CQ subQuery);

        public QDRFunction<Dchその他予定台帳CB> DerivedDchその他予定台帳List() {
            return xcreateQDRFunctionDchその他予定台帳List();
        }
        protected QDRFunction<Dchその他予定台帳CB> xcreateQDRFunctionDchその他予定台帳List() {
            return new QDRFunction<Dchその他予定台帳CB>(delegate(String function, SubQuery<Dchその他予定台帳CB> subQuery, String operand, Object value) {
                xqderiveDchその他予定台帳List(function, subQuery, operand, value);
            });
        }
        public void xqderiveDchその他予定台帳List(String function, SubQuery<Dchその他予定台帳CB> subQuery, String operand, Object value) {
            assertObjectNotNull("subQuery<Dchその他予定台帳CB>", subQuery);
            Dchその他予定台帳CB cb = new Dchその他予定台帳CB(); cb.xsetupForDerivedReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_QueryDerivedReferrer_Dchその他予定台帳List(cb.Query()); // for saving query-value.
            String parameterPropertyName = keepId_QueryDerivedReferrer_Dchその他予定台帳ListParameter(value);
            registerQueryDerivedReferrer(function, cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName, operand, value, parameterPropertyName);
        }
        public abstract String keepId_QueryDerivedReferrer_Dchその他予定台帳List(Dchその他予定台帳CQ subQuery);
        public abstract String keepId_QueryDerivedReferrer_Dchその他予定台帳ListParameter(Object parameterValue);
        ...
        public QDRFunction<Dch清掃予定台帳CB> DerivedDch清掃予定台帳List() {
            return xcreateQDRFunctionDch清掃予定台帳List();
        }
        protected QDRFunction<Dch清掃予定台帳CB> xcreateQDRFunctionDch清掃予定台帳List() {
            return new QDRFunction<Dch清掃予定台帳CB>(delegate(String function, SubQuery<Dch清掃予定台帳CB> subQuery, String operand, Object value) {
                xqderiveDch清掃予定台帳List(function, subQuery, operand, value);
            });
        }
        public void xqderiveDch清掃予定台帳List(String function, SubQuery<Dch清掃予定台帳CB> subQuery, String operand, Object value) {
            assertObjectNotNull("subQuery<Dch清掃予定台帳CB>", subQuery);
            Dch清掃予定台帳CB cb = new Dch清掃予定台帳CB(); cb.xsetupForDerivedReferrer(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepId_QueryDerivedReferrer_Dch清掃予定台帳List(cb.Query()); // for saving query-value.
            String parameterPropertyName = keepId_QueryDerivedReferrer_Dch清掃予定台帳ListParameter(value);
            registerQueryDerivedReferrer(function, cb.Query(), "id", "客室利用予定台帳id", subQueryPropertyName, operand, value, parameterPropertyName);
        }
        public abstract String keepId_QueryDerivedReferrer_Dch清掃予定台帳List(Dch清掃予定台帳CQ subQuery);
        public abstract String keepId_QueryDerivedReferrer_Dch清掃予定台帳ListParameter(Object parameterValue);
