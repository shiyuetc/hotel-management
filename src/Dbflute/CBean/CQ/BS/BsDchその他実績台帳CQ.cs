...
namespace Dbflute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public class BsDchその他実績台帳CQ : AbstractBsDchその他実績台帳CQ {

        protected Dchその他実績台帳CIQ _inlineQuery;

        public BsDchその他実績台帳CQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public Dchその他実績台帳CIQ Inline() {
            if (_inlineQuery == null) {
                _inlineQuery = new Dchその他実績台帳CIQ(xgetReferrerQuery(), xgetSqlClause(), xgetAliasName(), xgetNestLevel(), this);
            }
            _inlineQuery.xsetOnClause(false);
            return _inlineQuery;
        }
        
        public Dchその他実績台帳CIQ On() {
            if (isBaseQuery()) { throw new UnsupportedOperationException("Unsupported onClause of Base Table!"); }
            Dchその他実績台帳CIQ inlineQuery = Inline();
        ...
        public BsDchその他実績台帳CQ AddOrderBy_Id_Asc() { regOBA("id");return this; }
        public BsDchその他実績台帳CQ AddOrderBy_Id_Desc() { regOBD("id");return this; }
        ...
        public BsDchその他実績台帳CQ AddOrderBy_客室利用実績台帳id_Asc() { regOBA("客室利用実績台帳id");return this; }
        public BsDchその他実績台帳CQ AddOrderBy_客室利用実績台帳id_Desc() { regOBD("客室利用実績台帳id");return this; }

        public BsDchその他実績台帳CQ AddSpecifiedDerivedOrderBy_Asc(String aliasName) { registerSpecifiedDerivedOrderBy_Asc(aliasName); return this; }
        public BsDchその他実績台帳CQ AddSpecifiedDerivedOrderBy_Desc(String aliasName) { registerSpecifiedDerivedOrderBy_Desc(aliasName); return this; }

        public override void reflectRelationOnUnionQuery(ConditionQuery baseQueryAsSuper, ConditionQuery unionQueryAsSuper) {
            Dchその他実績台帳CQ baseQuery = (Dchその他実績台帳CQ)baseQueryAsSuper;
            Dchその他実績台帳CQ unionQuery = (Dchその他実績台帳CQ)unionQueryAsSuper;
        ...
        protected String resolveNextRelationPathDch客室利用実績台帳() {
            return resolveNextRelationPath("dchその他実績台帳", "dch客室利用実績台帳");
        }
	    ...
	    //                                                                 Scalar SubQuery
	    //                                                                 ===============
	    protected Map<String, Dchその他実績台帳CQ> _scalarSubQueryMap;
	    public Map<String, Dchその他実績台帳CQ> ScalarSubQuery { get { return _scalarSubQueryMap; } }
	    public override String keepScalarSubQuery(Dchその他実績台帳CQ subQuery) {
	        if (_scalarSubQueryMap == null) { _scalarSubQueryMap = new LinkedHashMap<String, Dchその他実績台帳CQ>(); }
        ...
        //                                                         =======================
        protected Map<String, Dchその他実績台帳CQ> _myselfInScopeSubQueryMap;
        public Map<String, Dchその他実績台帳CQ> MyselfInScopeSubQuery { get { return _myselfInScopeSubQueryMap; } }
        public override String keepMyselfInScopeSubQuery(Dchその他実績台帳CQ subQuery) {
            if (_myselfInScopeSubQueryMap == null) { _myselfInScopeSubQueryMap = new LinkedHashMap<String, Dchその他実績台帳CQ>(); }
