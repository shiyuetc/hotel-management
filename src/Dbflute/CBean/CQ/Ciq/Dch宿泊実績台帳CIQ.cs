...
namespace Dbflute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class Dch宿泊実績台帳CIQ : AbstractBsDch宿泊実績台帳CQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsDch宿泊実績台帳CQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public Dch宿泊実績台帳CIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsDch宿泊実績台帳CQ myCQ)
