...
namespace Dbflute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class Dch客室利用予定台帳CIQ : AbstractBsDch客室利用予定台帳CQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsDch客室利用予定台帳CQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public Dch客室利用予定台帳CIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsDch客室利用予定台帳CQ myCQ)
