...
namespace Dbflute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class Dchその他予定台帳CIQ : AbstractBsDchその他予定台帳CQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsDchその他予定台帳CQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public Dchその他予定台帳CIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsDchその他予定台帳CQ myCQ)
