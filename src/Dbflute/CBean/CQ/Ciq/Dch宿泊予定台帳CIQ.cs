...
namespace Dbflute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class Dch宿泊予定台帳CIQ : AbstractBsDch宿泊予定台帳CQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsDch宿泊予定台帳CQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public Dch宿泊予定台帳CIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsDch宿泊予定台帳CQ myCQ)
