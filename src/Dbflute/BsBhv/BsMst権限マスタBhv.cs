...
namespace Dbflute.ExBhv {
    ...
    public partial class Mst権限マスタBhv : Dbflute.AllCommon.Bhv.AbstractBehaviorWritable {
        ...
        public IList<Kbn権限区分> PulloutKbn権限区分(IList<Mst権限マスタ> mst権限マスタList) {
            return HelpPulloutInternally<Mst権限マスタ, Kbn権限区分>(mst権限マスタList, new MyInternalPulloutKbn権限区分Callback());
        }
        protected class MyInternalPulloutKbn権限区分Callback : InternalPulloutCallback<Mst権限マスタ, Kbn権限区分> {
            public Kbn権限区分 getFr(Mst権限マスタ entity) { return entity.Kbn権限区分; }
        }
