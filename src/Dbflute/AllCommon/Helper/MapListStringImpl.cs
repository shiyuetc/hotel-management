...
namespace Dbflute.AllCommon.Helper
{
    public class MapListStringImpl : MapListString
    {
        ...
        public Dictionary<String, Object> generateMap(string mapString)
        {
            ...
            if (!"".Equals(_remainderString) && !_endBrace.Equals(_remainderString))
            {
                ...
                throw new Dbflute.AllCommon.JavaLike.IllegalStateException(msg);
            }
            return generatedMap;
        }
        ...
        protected void removePrefix(String prefixString)
        {
            if (_remainderString == null)
            {
                ...
                throw new Dbflute.AllCommon.JavaLike.IllegalArgumentException(msg);
            }
            removeBothSideSpaceAndTabAndNewLine();
        ...
        protected void assertMapString(String mapString)
        {
            if (mapString == null)
            {
                ...
                throw new Dbflute.AllCommon.JavaLike.IllegalArgumentException(msg + "mapString=" + mapString);
            }
        ...
        protected void assertListString(String listString)
        {
            if (listString == null)
            {
                ...
                throw new Dbflute.AllCommon.JavaLike.IllegalArgumentException(msg + "liststring=" + listString);
            }
