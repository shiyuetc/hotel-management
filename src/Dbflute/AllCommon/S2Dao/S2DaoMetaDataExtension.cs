...
using Dbflute.AllCommon.Annotation;
...
using Dbflute.AllCommon.S2Dao.Internal.SqlCommand;
using Dbflute.AllCommon.S2Dao.Internal.RsHandler;
...
namespace Dbflute.AllCommon.S2Dao {
    ...
    public class BeanMetaDataDBFluteDBMetaExtension : BeanMetaDataImpl {
        protected Dbflute.AllCommon.JavaLike.List<IPropertyType> _primaryKeyList = new Dbflute.AllCommon.JavaLike.ArrayList<IPropertyType>();
